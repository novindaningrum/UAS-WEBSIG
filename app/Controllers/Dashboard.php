...
class Dashboard extends BaseController
{
   ...
   public function index(){
       ...
       // inisiasi object dari class PondokModel
       ...
       foreach ($query as $data_sekolah) {
           $lokasi .= '["'.$data_sekolah->npps.'" ,"'.$data_sekolah->nama_pondok.'","'.$data_sekolah->alamat_pondok.'","'.$data_sekolah->jenjang_pendidikan.'","'.$data_sekolah->status.'", '.$data_sekolah->koordinat.'],';
       }
       $data['marker'] = $lokasi;
